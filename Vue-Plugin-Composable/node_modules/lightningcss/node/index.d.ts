import type { Angle, CssColor, CustomProperty, Declaration, DeclarationBlock, EnvironmentVariable, Function, Image, LengthValue, Location2, MediaQuery, Multiplier, ParsedComponent, Ratio, Resolution, Rule, Selector, StyleRule, StyleSheet, SupportsCondition, Time, Token, TokenOrValue, UnknownAtRule, Url, Variable } from 'lightningcss/node/ast';
import { Features, Targets } from 'lightningcss/node/targets';
